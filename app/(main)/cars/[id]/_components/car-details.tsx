      ...
      <div className="flex flex-col lg:flex-row gap-8 pt-8">
        ...
        <div className="w-full lg:w-5/12">
          <div className="flex items-center justify-between">
            <Badge className="mb-2 bg-black text-white">{car.bodyType}</Badge>
          </div>
          ...
          <div className="text-2xl font-bold text-[#194d6f]">
          ...
          <Dialog>
              ...
              <Card className="pt-5">
                <CardContent>
                  <div className="flex items-center gap-2 text-lg font-medium mb-2">
                    <Currency className="h-5 w-5 text-[#194d6f]" />
            ...
            <DialogContent className="bg-gray-50">
              <DialogHeader>
                <DialogTitle>Vroomgo AI Car Loan Calculator</DialogTitle>
          ...
          <Card className="my-6">
            <CardContent className="p-4">
              <div className="flex items-center gap-2 text-lg font-medium mb-2">
                <MessageSquare className="h-5 w-5 text-[#194d6f]" />
              ...
              <a href="mailto:help@vroomgoai.in">
          ...
          <div>
            ...
            <ul className="grid grid-cols-1 gap-2">
              <li className="flex items-center gap-2">
                <span className="h-2 w-2 bg-[#194d6f] rounded-full"></span>
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          <div className="flex flex-col md:flex-row gap-6 justify-between">
            ...
            <div className="flex items-start gap-3">
              <LocateFixed className="h-5 w-5 text-[#194d6f] mt-1 flex-shrink-0" />
              <div>
                <h4 className="font-medium">Vroomgi AI Motors</h4>
