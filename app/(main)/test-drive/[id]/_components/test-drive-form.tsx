...
export function TestDriveForm({ car, testDriveInfo }) {
  ...
  useEffect(() => {
    if (bookingResult?.success) {
      console.log("Booking success data:", bookingResult.data);
      setBookingDetails({
        date: format(parseISO(bookingResult?.data?.bookingDate), "EEEE, MMMM d, yyyy"),
        timeSlot: `${format(
      ...
      <div className="md:col-span-1">
        <Card>
          <CardContent className="p-6">
            ...
            <div className="mt-2 text-xl font-bold text-[#194d6f]">
            ...
            <div className="py-4">
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span>{bookingDetails?.date || "Date not available"}</span>
                </div>
                <div className="flex justify-between">
                  <span className="font-medium">Time Slot:</span>
                  <span>{bookingDetails?.timeSlot || "Time not available"}</span>
                </div>
                <div className="flex justify-between">
              ...
              <div className="mt-4 bg-blue-50 p-3 rounded text-sm text-[#194d6f]">
