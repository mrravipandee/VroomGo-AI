...
CREATE TABLE "DealershipInfo" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL DEFAULT 'VroomGo Ai Dealership',
    "address" TEXT NOT NULL DEFAULT 'satpur, Nashik, Maharashtra 422010',
    "phone" TEXT NOT NULL DEFAULT '+91 89898 89898',
    "email" TEXT NOT NULL DEFAULT 'contactus@vroomgoai.com',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
