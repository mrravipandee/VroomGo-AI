        ...
        <header className='fixed top-0 w-full bg-white/70 backdrop-blur-md z-50 border-b '>
            <nav className='mx-auto px-4 py-4 flex items-center justify-between'>
                <Link href={isAdminPage ? "/admin" : "/"} className='flex items-center'>
                    <Image src="/logo.svg" alt='Logo' width={200} height={60} className='h-12 w-auto object-contain' />
                    {isAdminPage && (
                ...
                <div className="flex items-center space-x-4">
                    ...
                    {/* Login Button (Only visible when user is signed out) */}
                    <SignedOut>
                    ...
                    {/* User Profile Button (Only visible when user is signed in) */}
                    <SignedIn>
